...
import animo.model.PropertyBag;
...
public class XMLSerializer {
	...
	public Model deserializeModel(Document d) throws SerializationException {
		final AXPathExpression modelProperties = XmlEnvironment.hardcodedXPath("/ANIMO-model/properties");
		final AXPathExpression vertices = XmlEnvironment.hardcodedXPath("/ANIMO-model/reactants/reactant");
		final AXPathExpression edges = XmlEnvironment.hardcodedXPath("/ANIMO-model/reactions/reaction");
