...
public class UppaalInvoker {
	 ...
	 */
	private static final String LEAVE_KEY = "/ANIMO/UppaalInvoker/leaveFiles";

	/**
	 * The configuration key for the temporary location property.
	 */
	private static final String TEMP_KEY = "/ANIMO/UppaalInvoker/temporary";

	/**
	 * The configuration key for the tracer path property.
	 */
	private static final String TRACER_KEY = "/ANIMO/UppaalInvoker/tracer";

	/**
	 * The configuration key for the verifyta path property.
	 */
	private static final String VERIFY_KEY = "/ANIMO/UppaalInvoker/verifyta";
