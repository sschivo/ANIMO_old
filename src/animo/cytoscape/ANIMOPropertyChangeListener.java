...
public class ANIMOPropertyChangeListener implements PropertyChangeListener {
	
	private int currentEdgeNumber = -1, currentNodeNumber = -1;
	private Object[] edgesArray = null;

	public ANIMOPropertyChangeListener() {
	...
	private void addVisualMappings() {
		...
		gac.setDefaultNodeSelectionColor(Color.BLUE);
