...
/**
 * Augments the current view with ANIMO capabilities.
 * 
...
public class AugmentAction extends CytoscapeAction implements NodeContextMenuListener, EdgeContextMenuListener {
	 ...
	 */
	public AugmentAction(ANIMOPlugin plugin) {
		super("Augment view");
	}

	/**
	 * This allows us to perform some updates to the standard Cytoscape interface,
	 * in order to allow the user to interact with the model via ANIMO functions.
	 ...
	 * about the current activity level of a reactant (see the JSlider in ANIMOResultPanel).
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		mapping.putMapValue(Model.Properties.TYPE_COMPLEX, NodeShape.HEXAGON);
		...
		mapping.putMapValue(Model.Properties.TYPE_COMPLEX, 60.0f);
